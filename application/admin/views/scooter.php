...
<html>
    ...
    <body> 
        <div id="content">
            ...
            <section>
                <nav>
                    <a href="../controllers/scooter.php?action=add" title="Add New Scooter">Add New Scooter</a>
                ...
                <?php
                    ...
                    $rows = $model->getNumberOfScooters();
                ...
                ?>
                <form id="delete_all" action="../controllers/scooter.php?action=delete&type=all" method="POST">
                <table border="1" >
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php echo $workpoints = $model->getScooterList($max);?>
                    </tbody>
                </table>
                </form>
            </section>

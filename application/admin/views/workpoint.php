    ...
    <body> 
        ...
        $(document).ready(function () {
            ...
            $('#WorkpointTableContainer').jtable({
                ...
                actions: {
                    listAction: 'workpointsList.php?action=list',
                    createAction: 'workpointsList.php?action=create',
                    updateAction: 'workpointsList.php?action=update',
                    deleteAction: 'workpointsList.php?action=delete'
                },
                fields: {
                    id: {
                        key: true,
